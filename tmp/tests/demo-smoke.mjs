...
const moduleSources = {
  '11-module-graph-tsx.html': [
    ['modules/state.ts', 'ts'],
    ['modules/view.tsx', 'tsx'],
    ['modules/main.tsx', 'tsx']
  ],
  '13-cdn-module-tsx.html': [
    ['modules/cdn-data.ts', 'ts'],
    ['modules/cdn-view.tsx', 'tsx'],
    ['modules/cdn-main.tsx', 'tsx']
  ],
  '14-multifile-jsx/index.html': [
    ['14-multifile-jsx/api.js', 'js'],
    ['14-multifile-jsx/state.js', 'js'],
    ['14-multifile-jsx/view.jsx', 'jsx'],
    ['14-multifile-jsx/app.jsx', 'jsx']
  ],
  '15-multifile-tsx/index.html': [
    ['15-multifile-tsx/data.ts', 'ts'],
    ['15-multifile-tsx/api.ts', 'ts'],
    ['15-multifile-tsx/state.ts', 'ts'],
    ['15-multifile-tsx/view.tsx', 'tsx'],
    ['15-multifile-tsx/app.tsx', 'tsx']
  ]
}
